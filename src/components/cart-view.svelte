        ...
        <ul class="flex justify-between">
            ...
            <li>
                <p>
                    ...
                    {userCart?.items.length > 0 && userCart?.items.map(quantity).reduce(sum) === 1
                        ? "item"
                        : "items"}
                </p>
            </li>
        ...
        <ul class="list">
            {#if userCart.items.length < 1}
                <div>
                    ...
                    <p class="sub-text" style="text-align: center">Your cart is currently empty</p>
                </div>
            {:else }
                        ...
                        <div class="product-ctn">
                            <div style="display: flex">
                                ...
                                <ul class="ml-7">
                                    ...
                                    <li>
                                        <p class="sub-text">
                                            Price: { formatPrice(unit_price, userCart.region.currency_code)} </p>
                                    </li>
                                    ...
                                    <li>
                                        <p on:click={() =>  deleteVariantFromCart(id) } class="remove-btn"> Remove </p>
                                    </li>
                                </ul>
                            </div>
                        </div>
