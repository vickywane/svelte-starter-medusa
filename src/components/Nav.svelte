...
<nav>
	<div class="header-ctn" >
		<ul class="header-items" >
			<li>
				<a href="/" >
					<img class="logo" alt="Medusa logo in navbar" src="https://res.cloudinary.com/dkfptto8m/image/upload/v1636640334/medusa-logo.jpg" />
				</a>
			</li>
			...
			{#if hideCartControls}
				...
				<li style="text-align: right" class="cursor-pointer pt-3" on:click={() => setCheckoutState(true)} >
					<ul class="flex"  >
